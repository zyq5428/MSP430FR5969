...
void oled_display_memu(void)
{
    ...
    OLED_ShowCHinese(12,0,0);//温
    OLED_ShowCHinese(40,0,1);//湿
    OLED_ShowCHinese(70,0,2);//度
    OLED_ShowCHinese(98,0,3);//计

    OLED_ShowCHinese(0,3,0);//温
    OLED_ShowCHinese(20,3,2);//度
//        OLED_ShowString(56,3,":");
//    OLED_ShowString(48,3,"26.50");
    OLED_ShowCHinese(96,3,4);//℃

    OLED_ShowCHinese(0,5,1);//湿
    OLED_ShowCHinese(20,5,2);//度
